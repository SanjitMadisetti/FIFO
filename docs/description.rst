A common clock control the readin and writing activity of a synchronous FIFO. The status unit of a synchronous FIFO is simplified because a simple up-down counter can be controlled by the common clock to monitor the gap between the pointers and detect full and empty conditions.
